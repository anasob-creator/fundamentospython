# Versión 2 de la calculadora
# Tiene que hacer un bucle para que el usuario hasta que el usuario seleccione la opción que yo desee o hasta que quiera salir
# En el main
